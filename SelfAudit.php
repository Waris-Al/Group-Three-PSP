...
<body>
  ...
  <form>
    <ul>
    <li>Accessibility Tab on the Homepage <input type='radio' id='task-0-yes' name='task-0' value='yes'>Yes<input type='radio' id='task-0-no' name='task-0' value='no'>No</li>
      ...
      <li>Accessible On-Site Parking <input type='radio' id='task-8-yes' name='task-8' value='yes'>Yes<input type='radio' id='task-8-no' name='task-8' value='no'>No</li>
